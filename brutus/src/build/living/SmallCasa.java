...
public class SmallCasa extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 17 ,WEALTH = 35,CLASS_ID = 7;
	

	public SmallCasa(Field place,int startCivilians) {
