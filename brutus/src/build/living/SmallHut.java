...
public class SmallHut extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 9 ,WEALTH = 15,CLASS_ID = 3;
	

	public SmallHut(Field place,int startCivilians) {
