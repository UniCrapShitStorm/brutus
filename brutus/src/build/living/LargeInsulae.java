...
public class LargeInsulae extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 84 ,WEALTH = 65,CLASS_ID = 11;
	

	public LargeInsulae(Field place,int startCivilians) {
