...
public class RoyalInsulae extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 84 ,WEALTH = 80,CLASS_ID = 12;
	

	public RoyalInsulae(Field place,int startCivilians) {
