...
public class LuxVilla extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 100 ,WEALTH = 600,CLASS_ID = 16;
	

	public LuxVilla(Field place,int startCivilians) {
