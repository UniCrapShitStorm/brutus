...
public class MidPalace extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 112 ,WEALTH = 900,CLASS_ID = 18;
	

	public MidPalace(Field place,int startCivilians) {
