...
public class LargeCasa extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 19 ,WEALTH = 45,CLASS_ID = 8;
	

	public LargeCasa(Field place,int startCivilians) {
