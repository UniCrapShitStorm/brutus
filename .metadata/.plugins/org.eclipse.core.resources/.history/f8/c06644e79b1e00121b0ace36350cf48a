...
public class LargePalace extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 190 ,WEALTH = 1500,CLASS_ID = 19;
	
	
	public LargePalace(Field place,int startCivilians) {
