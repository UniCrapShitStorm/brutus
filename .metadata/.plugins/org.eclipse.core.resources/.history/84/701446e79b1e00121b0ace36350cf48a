...
public class SmallHouse extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 13 ,WEALTH = 25,CLASS_ID = 5;
	

	public SmallHouse(Field place,int startCivilians) {
