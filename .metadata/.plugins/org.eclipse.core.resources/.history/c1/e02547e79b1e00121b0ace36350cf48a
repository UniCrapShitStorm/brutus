...
public class SmallInsulae extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 19 ,WEALTH = 50,CLASS_ID = 9;
	

	public SmallInsulae(Field place,int startCivilians) {
