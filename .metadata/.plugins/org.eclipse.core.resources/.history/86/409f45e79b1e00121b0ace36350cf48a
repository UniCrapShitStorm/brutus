...
public class MidInsulae extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 20 ,WEALTH = 58,CLASS_ID = 10;
	

	public MidInsulae(Field place,int startCivilians) {
