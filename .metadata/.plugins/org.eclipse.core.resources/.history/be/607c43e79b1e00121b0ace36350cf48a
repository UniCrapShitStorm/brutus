...
public class SmallVilla extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 40 ,WEALTH = 150,CLASS_ID = 13;
	

	public SmallVilla(Field place,int startCivilians) {
