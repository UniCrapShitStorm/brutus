...
public class LargeHouse extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 15 ,WEALTH = 30,CLASS_ID = 6;
	

	public LargeHouse(Field place,int startCivilians) {
