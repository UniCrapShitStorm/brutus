...
public class SmallPalace extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 106 ,WEALTH = 700,CLASS_ID = 17;
	

	public SmallPalace(Field place,int startCivilians) {
