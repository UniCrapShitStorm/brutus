...
public class LargeVilla extends Living {
	private boolean burning;
	public static final int MAX_CIVS = 90 ,WEALTH = 400,CLASS_ID = 15;
	
	
	public LargeVilla(Field place,int startCivilians) {
